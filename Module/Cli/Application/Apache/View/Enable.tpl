{terminal.color('white')}Information about: {terminal.color('light-green-blue')}<{$binary}> Apache Enable{terminal.color('reset')}
...
use {terminal.color('white')}{$binary} apache restart{terminal.color('reset')} to activate the domain...
