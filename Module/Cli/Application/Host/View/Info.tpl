{terminal.color('white')}Information about: {terminal.color('light-green-blue')}<{$binary}> Host{terminal.color('reset')}
...
{terminal.color('white')}{$binary} host info{terminal.color('reset')}
{terminal.color('white')}{$binary} host create {terminal.color('light-green-blue')}<ip> <host>{terminal.color('reset')}
{terminal.color('white')}{$binary} host delete {terminal.color('light-green-blue')}<host>{terminal.color('reset')}
{terminal.color('white')}{$binary} host backup{terminal.color('reset')}
{terminal.color('white')}{$binary} host restore {terminal.color('light-green')}list{terminal.color('reset')}
