{terminal.color('white')}Information about: {terminal.color('light-green-blue')}<{$binary}> Host Restore{terminal.color('reset')}
...
{/for.each}
use {terminal.color('white')}{$binary} host restore <date> <time>{terminal.color('reset')} to restore to that point
