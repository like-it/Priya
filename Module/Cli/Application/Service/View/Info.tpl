{terminal.color('white')}Information about: {terminal.color('light-green-blue')}<{$binary}>{terminal.color('reset')}
...
{terminal.color('white')}info{terminal.color('reset')}
{terminal.color('white')}cron start{terminal.color('reset')}
{terminal.color('white')}cron stop{terminal.color('reset')}
